"""
Django settings for webtestdep project.
...
SECRET_KEY = '4!aojj@(ivb^^3mf2%1-5t!$^lvy6xrq)tesg_ex6!yqddmpu('
...
WSGI_APPLICATION = 'webtestdep.wsgi.application'
